    ...
    <footer className="bg-[#1A1036] container-m py-5 text-center text-white flex flex-col justify-center">
      <div className="footerContents">
        ...
        <div className="footerList hidden sm:block my-3">
          <ul>
            <li className="inline mx-1" onClick={() => scroll("home")}>
              Home{" "}
            </li>
            <li className="inline mx-1" onClick={() => scroll("features")}>
              Our Features
            </li>
            <li className="inline mx-1" onClick={() => scroll("discounts")}>
              Discounts
            </li>
            <li className="inline mx-1" onClick={() => scroll("blog")}>
              Blog
            </li>
            <li className="inline mx-1" onClick={() => scroll("trending")}>
              Trending Tracks
            </li>
        ...
        <div className="footerEnd mt-5  flex flex-row justify-center">
          <div className="copy flex">
            <span className="text-white text-sm sm:text-md">
              @Copyrights Lotreach. <br className="spanBreak" /> All rights
              Reserved
            </span>
          </div>
