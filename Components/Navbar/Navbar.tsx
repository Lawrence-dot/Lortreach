...
function Navbar() {
  ...
  return (
    <div
      className={`flex wrap sticky-top ${
    ...
    >
      <div
        ...
        style={{ borderBottom: `${open && "1px solid rgb(0 0 0 / 5%)"}` }}
      >
        <img src="/logo.ico" />
        <p className="hidden sm:block"> Lortrech</p>
        <button
          onClick={toggleNav}
          className={`${Styles.navToggler} bg-primary rounded-lg text-primary text-xl sm:hidden ml-auto`}
        >
      ...
      <div
        className={`${Styles.navList} w-full mt-3 navLists sm:hidden`}
        style={{
