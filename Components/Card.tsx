    ...
    <div className={`card mx-auto  sm:mx-2 px-1 pb-3`}>
      ...
      <div className="faangEth m-3 sm:m-2 flex">
        <div className="flex ethContainer">
          ...
          >
            <path
              d="M10.9176 10.1374L5.68246 13.4177L0.443863 10.1374L5.68246 0.918579L10.9176 10.1374ZM5.68246 14.4711L0.443863 11.1908L5.68246 19.0169L10.9211 11.1908L5.68246 14.4711Z"
              fill="#00AC4F"
            />
          </svg>
    ...
    <div className="tCard p-2 w-full md:w-1/2 m-2 flex">
      ...
      <div className="tInfo ml-2 my-auto">
        ...
        <div className="flex mt-1">
          ...
          <span className="ml-1 text-sm sm:text-md md:text-lg trendEth">
            {" "}
            {props.eth}{" "}
          </span>
        </div>
      ...
      <div className="tpercent ml-auto my-auto">
        <span
          className={`${
            props.percent > 21 ? "text-primary" : "text-[#FF002E]"
